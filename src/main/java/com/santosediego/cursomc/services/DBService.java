...
import com.santosediego.cursomc.domain.Pagamento;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@email.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli1.getTelefones().addAll(Arrays.asList("3435391788", "93838393"));

		Cliente cli2 = new Cliente(null, "Michael Knight", "michael@email.com", "29671331670", TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363323", "34987420528"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Jacarandá", "412", "Casa", "Morada dos Pássaros", "38406371", cli2, c1);
