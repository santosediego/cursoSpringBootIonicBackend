...
import com.santosediego.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		HttpStatus code = HttpStatus.valueOf(e.getErrorCode()); // Pega o código do erro vindo Exception da Amazon;
	...
	public ResponseEntity<StandardError> maxUpload(MaxUploadSizeExceededException e, HttpServletRequest request) {

		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(),
				"Tamanho máximo upload", e.getMessage(), request.getRequestURI());
